...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">GYM's Enquiry <i class="fas fa-users"></i></h1>
  </div>
  ...
  <form role="form" action="index.php" method="POST">
            ...
            $contact = $_POST["contact"];
                    ...
                    $qry = "insert into enquiry(fullname,email,address,services,gender,contact) values ('$fullname','$email','$address','$services','$gender','$contact')";
                    ...
                    echo"<div class='container-fluid'>";
                        ...
                        echo"<div class='widget-title'> <span class='icon'> <i class='fas fa-info'></i> </span>";
                            ...
                            echo"<div class='widget-content'>";
                                echo"<div class='error_ex'>";
                                echo"<h1>Success</h1>";
                                echo"<h3>Enquiry details has been added!</h3>";
                                echo"<p>The requested enquiry details are added to database. Please click the button to go back.</p>";
                                echo"<a class='btn btn-inverse btn-big'  href='enquiry.php'>Go Back</a> </div>";
                            echo"</div>";
                            echo"</div>";
                        echo"</div>";
                        echo"</div>";
