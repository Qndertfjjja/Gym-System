...
<div class="container-fluid">
  ...
  <div class="row-fluid">
          ...
          <form action="edit-member-req.php" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <span class="help-block">Date of birth</span> </div>
            </div>
    ...
    <option value="30" <?php if ($row['plan'] == '30') echo 'selected="selected"'; ?>>One Month</option>
    <option value="90" <?php if ($row['plan'] == '90') echo 'selected="selected"'; ?>>Three Month</option>
    <option value="180" <?php if ($row['plan'] == '180') echo 'selected="selected"'; ?>>Six Month</option>
    <option value="365" <?php if ($row['plan'] == '365') echo 'selected="selected"'; ?>>One Year</option>
</select>
